--[[
    ...
    Загрузи через:
        MacLib:Preloader("https://raw.githubusercontent.com/.../ProgressBar_Element.lua", function()
            local pb = mySection:ProgressBar({ Name="Health", Default=80, Color=Color3.fromRGB(60,200,100) }, "PB_Health")
        end)
]]
...
return function(ctx)
    ...
    -- Регистрируем элемент ProgressBar
    ...
    -- Добавляем метод section:ProgressBar() во все секции
