--[[
    MacLib PreLoader — CheckBox
    Загрузи этот файл через MacLib:Preloader(url, callback)

    Пример использования:
    MacLib:Preloader("https://raw.githubusercontent.com/.../CheckBox_PreLoader.lua", function(module)
        -- элемент CheckBox зарегистрирован и готов
    end)
]]
