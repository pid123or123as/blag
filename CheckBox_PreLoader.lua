--[[
    ...
    Загрузи через:
        MacLib:Preloader("https://raw.githubusercontent.com/.../CheckBox_Element.lua", function()
            local cb = mySection:CheckBox({ Name="Option A", Default=false,
                Callback = function(v) print("CheckBox:", v) end }, "CB_A")
        end)
]]
...
return function(ctx)
    ...
    MacLib:RegisterElement("CheckBox", {
        ...
        local function refresh()
            ck.TextTransparency       = el.Checked and 0.05 or 1
            box.BackgroundColor3      = el.Checked and Color3.fromRGB(60, 160, 255) or Color3.fromRGB(255, 255, 255)
    ...
    -- Добавляем метод section:CheckBox() во все секции
